...
export default function InfiniteScroll({
  ...
  // ----- Items Prop -----
  items = [],                  // Array of items with { src: "image-url", alt: "description" }
  itemMinHeight = 150,         // Fixed height for each image container
  // ----- Tilt Props -----
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center border-2 rounded-xl select-none box-border relative overflow-hidden"
            key={i}
            style={{
